...
### all\_directories `instance-attribute` [¶](#fastapi.staticfiles.StaticFiles.all_directories "Permanent link")
...
### config\_checked `instance-attribute` [¶](#fastapi.staticfiles.StaticFiles.config_checked "Permanent link")

```python
config_checked = False
```

### follow\_symlink `instance-attribute` [¶](#fastapi.staticfiles.StaticFiles.follow_symlink "Permanent link")

```python
follow_symlink = follow_symlink
```

### get\_directories [¶](#fastapi.staticfiles.StaticFiles.get_directories "Permanent link")
...
### get\_path [¶](#fastapi.staticfiles.StaticFiles.get_path "Permanent link")
...
### get\_response `async` [¶](#fastapi.staticfiles.StaticFiles.get_response "Permanent link")
...
### lookup\_path [¶](#fastapi.staticfiles.StaticFiles.lookup_path "Permanent link")
...
### file\_response [¶](#fastapi.staticfiles.StaticFiles.file_response "Permanent link")
...
### check\_config `async` [¶](#fastapi.staticfiles.StaticFiles.check_config "Permanent link")
...
### is\_not\_modified [¶](#fastapi.staticfiles.StaticFiles.is_not_modified "Permanent link")
